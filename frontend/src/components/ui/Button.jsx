...
const variants = {
  ...
  secondary: 'btn bg-ink-700 text-fg-strong hover:bg-ink-600 border border-ink-600',
  ghost: 'btn bg-transparent text-fg-muted hover:bg-ink-800 hover:text-fg-strong',
  outline: 'btn bg-transparent text-fg-strong border border-ink-600 hover:border-brand-500 hover:text-fg-strong',
